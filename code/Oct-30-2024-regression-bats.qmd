...
#There may be a slight positive relationship between the number of arousals and the amount of mass lost in bats.
...
Slope is rise/run, which in this case is about *1.9-.2 = 1.7* for rise and *16-4 = 12* for run, so we get *1.7/12 = .1417* as our guesstimate of the slope.

Eyeballing the plot, we would also guess that the y-intercept is somewhere around *(0,.1)*FILL IN VALUE
...
```{r}
#Bats that have more arousals will have significantly more mass loss (g)
```
